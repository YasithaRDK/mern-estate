  ...
  return (
    <div>
      ...
      <div className="flex flex-col max-w-6xl gap-6 px-3 mx-auto py-28">
        ...
        <div className="text-xs text-green-400 sm:text-sm">
          Plipzy Estate is the best place to find your next perfect place to
          live.
          <br />e have a wide range of properties for you to choose from.
        </div>
        <Link
          to="/search"
